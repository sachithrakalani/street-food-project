...
class AddReviewsAluthkade extends StatefulWidget {
  final Map<String, dynamic> aluthkadeData;
  const AddReviewsAluthkade({Key? key, required this.aluthkadeData}) : super(key: key);

  @override
  State<AddReviewsAluthkade> createState() => _AddReviewsAluthkadeState();
}

class _AddReviewsAluthkadeState extends State<AddReviewsAluthkade> {
