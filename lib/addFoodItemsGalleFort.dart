...
class AddFoodItemsGalleFort extends StatefulWidget {
  final Map<String, dynamic> galleFortData;
  const AddFoodItemsGalleFort({Key? key, required this.galleFortData}) : super(key: key);

  @override
  State<AddFoodItemsGalleFort> createState() => _AddFoodItemsGalleFortState();
}

class _AddFoodItemsGalleFortState extends State<AddFoodItemsGalleFort> {
